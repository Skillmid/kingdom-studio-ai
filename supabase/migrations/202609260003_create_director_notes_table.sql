...
CREATE INDEX IF NOT EXISTS idx_director_notes_production_scene
...
COMMENT ON TABLE public.director_notes IS
    'Production direction notes derived from scenes, shots and storyboard panels or created by the filmmaker.';
