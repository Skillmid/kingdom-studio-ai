...
interface StoryBibleNarrativeProps {
  ...
  onBeginningChange: (value: string) => void; onConflictChange: (value: string) => void; onMidpointChange: (value: string) => void; onClimaxChange: (value: string) => void; onEndingChange: (value: string) => void;
}

export default function StoryBibleNarrative({ beginning, conflict, midpoint, climax, ending, onBeginningChange, onConflictChange, onMidpointChange, onClimaxChange, onEndingChange }: StoryBibleNarrativeProps) {
  ...
  return (
    <section className="rounded-3xl border border-zinc-800 bg-zinc-900 p-8">
      <div className="mb-8">
        <p className="text-sm uppercase tracking-[0.3em] text-yellow-500">Section 4</p>
        <h2 className="mt-2 text-3xl font-bold">Narrative Structure</h2>
